...
class DesignerMainWindow(QtGui.QMainWindow, Ui_MainWindow):
    def __init__(self,parent=None):
        ...
        if not os.path.exists(HOME+'/.skyQuery_cache'):        
            print 'Creating .skyQuery_cache cache diretory in %s' %HOME
            os.makedirs(HOME+'/.skyQuery_cache')
            
        os.chdir(HOME+'/.skyQuery_cache')
